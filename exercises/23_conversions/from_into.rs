...
impl From<&str> for Person {
    fn from(s: &str) -> Self {
        ...
        // If the split operation returns less or more than 2 elements, return the default `Person`.
        if parts.len() != 2 {
            return Person::default();
        }

        // Use the first element from the split operation as the name.
        ...
        // Parse the second element from the split operation into a `u8` as the age.
